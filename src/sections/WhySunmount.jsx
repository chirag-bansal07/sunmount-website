...
const PILLARS = [
  {
    ...
    text: 'To promote renewable energy solutions by making solar installations easier and more accessible — eliminating dependence on fossil fuels, one rooftop at a time.',
    angle: -60,
  },
  {
    id: 'vision',
    ...
    text: 'To solve our clients\' dynamic needs in design and engineering with innovative solutions — backed by reliable scientific analysis and certifications, while staying competitive in pricing.',
    angle: 0,
  },
  {
    id: 'ambition',
    ...
    text: 'Best-in-class raw materials, manufacturing, scientific analysis, documentation, timelines, warranty, and swift after-sales — delivering an instant WOW experience, always.',
    angle: 60,
  },
]
  ...
  return (
    <section id="why" style={{
      ...
      <div style={{
        ...
        backgroundImage: 'radial-gradient(rgba(143,160,187,0.07) 1px, transparent 1px)',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              boxShadow: '0 0 80px rgba(255,107,26,0.4), inset -10px -10px 30px rgba(0,0,0,0.3)',
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '50%',
                    background: isActive
                      ? 'radial-gradient(circle, rgba(255,107,26,0.3) 0%, rgba(255,107,26,0) 70%)'
                      : 'transparent',
                    border: 'none',
                    cursor: 'pointer',
                ...
                >
                  <div style={{
                    ...
                    letterSpacing: '0.1em',
                    transition: 'all 0.4s',
                    boxShadow: isActive ? '0 0 30px rgba(255,107,26,0.5)' : 'none',
                  }}>
                    {pillar.label}
                  </div>
                </button>
            ...
            <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
              {PILLARS.map(pillar => {
                ...
                const cx = '50%'
                const cy = '50%'
                const x2 = `calc(50% + ${Math.cos(rad - Math.PI / 2) * 130}px)`
                const y2 = `calc(50% + ${Math.sin(rad - Math.PI / 2) * 130}px)`
                return (
                  <line
                    key={pillar.id}
